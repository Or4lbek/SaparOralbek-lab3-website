					...
					<li class="nav-item dropdown">
                     ...
                     @switch($locale)
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('coffee')}}/en"><img src="{{asset('images/us.png')}}"> English</a>
                            <a class="dropdown-item" href="{{ route('coffee')}}/ru"><img src="{{asset('images/ru.png')}}"> Russian</a>
                            <a class="dropdown-item" href="{{ route('coffee')}}/kz"><img src="{{asset('images/kz2.png')}}"> Kazakh</a>
