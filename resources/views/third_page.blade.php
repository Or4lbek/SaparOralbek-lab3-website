...
<body onload="load()">
	<div class="header">
        ...
        <div id="Coffee" onmouseover = "big(this)" onmouseout="def(this)"><a href = "{{ route('coffee')}}">{{__('third_page.coffee_h')}}</a></div>
        <div id="Order_online" onclick = "change(this)" onmouseover = "big(this)" onmouseout="def(this)" ><a href = "{{ route('order')}}">{{__('third_page.order_o_h')}}</a></div>
        <div id="Contacts" onclick = "change(this)" onmouseover = "big(this)" onmouseout="def(this)"><a href = "{{ route('contacts')}}">{{__('third_page.contacts_h')}}</a></div>
    </div>
   

    <div class="main">
        <div class="imgmain">
            <img id="img" src="{{asset('images/bag.png.png')}}" alt="cofee" width="420px">
        </div>
        
        <div class="text" >
             <h1 id="text1">{{__('third_page.coffee')}}</h1>
              <p >{{__('third_page.about_c')}}
        </div>
    </div>
    <script>
